...
export class SceneManager {
    constructor(app) {
        ...
        this.randomizationManager = new RandomizationManager(app);
    ...
    setupEventListeners() {
        ...
        // Set up randomization event listeners
        this.randomizationManager.setupRandomizationListeners();
    }
     ...
     */
    destroy() {
        // Clean up randomization manager
        if (this.randomizationManager) {
            this.randomizationManager.destroy();
        }
