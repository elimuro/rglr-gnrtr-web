    ...
    updateAnimationParameter(target, value) {
        ...
        switch (target) {
            case 'movementAmplitude':
                this.state.set('movementAmplitude', value);
                break;
            case 'rotationAmplitude':
                this.state.set('rotationAmplitude', value);
                break;
            case 'scaleAmplitude':
            ...
            case 'randomness':
                ...
                break;
            case 'cellSize':
                this.state.set('cellSize', value);
                if (this.scene) this.scene.updateCellSize();
                break;
            case 'movementFrequency':
                this.state.set('movementFrequency', value);
                break;
            case 'rotationFrequency':
                this.state.set('rotationFrequency', value);
                break;
            case 'scaleFrequency':
                this.state.set('scaleFrequency', value);
                break;
            case 'gridWidth':
            ...
            case 'compositionHeight':
                ...
                break;
            case 'animationType':
                this.state.set('animationType', Math.floor(value));
                break;
            case 'sphereRefraction':
                this.state.set('sphereRefraction', value);
            ...
            case 'sphereMetalness':
                ...
                break;
            case 'sphereScale':
                this.state.set('sphereScale', value);
            ...
            case 'sphereEnvMapIntensity':
                this.state.set('sphereEnvMapIntensity', value);
                if (this.scene) this.scene.updateSphereMaterials();
                break;
            ...
            case 'bloomStrength':
                this.state.set('bloomStrength', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            case 'bloomRadius':
                this.state.set('bloomRadius', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            case 'bloomThreshold':
            ...
            case 'vignetteSoftness':
                ...
                break;
            case 'grainIntensity':
                this.state.set('grainIntensity', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            case 'colorHue':
                this.state.set('colorHue', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            case 'colorSaturation':
                this.state.set('colorSaturation', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            case 'colorBrightness':
                this.state.set('colorBrightness', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            case 'colorContrast':
                this.state.set('colorContrast', value);
                if (this.scene) this.scene.updatePostProcessing();
                break;
            // Lighting parameters
            case 'ambientLightIntensity':
                this.state.set('ambientLightIntensity', value);
                if (this.scene) this.scene.updateLighting();
                break;
            case 'directionalLightIntensity':
                this.state.set('directionalLightIntensity', value);
                if (this.scene) this.scene.updateLighting();
                break;
            case 'pointLight1Intensity':
                this.state.set('pointLight1Intensity', value);
                if (this.scene) this.scene.updateLighting();
                break;
            case 'pointLight2Intensity':
                this.state.set('pointLight2Intensity', value);
                if (this.scene) this.scene.updateLighting();
                break;
            case 'rimLightIntensity':
                this.state.set('rimLightIntensity', value);
                if (this.scene) this.scene.updateLighting();
                break;
            case 'accentLightIntensity':
                this.state.set('accentLightIntensity', value);
                if (this.scene) this.scene.updateLighting();
                break;
            case 'lightColour':
            ...
            case 'shapeCyclingSpeed':
                this.state.set('shapeCyclingSpeed', value);
                break;
            case 'shapeCyclingPattern':
                this.state.set('shapeCyclingPattern', Math.floor(value));
                break;
            case 'shapeCyclingDirection':
                this.state.set('shapeCyclingDirection', Math.floor(value));
                break;
            case 'shapeCyclingSync':
                this.state.set('shapeCyclingSync', Math.floor(value));
                break;
            case 'shapeCyclingIntensity':
                this.state.set('shapeCyclingIntensity', value);
                break;
